    ...
    const handleUpdate = () => {
        axios
            ...
            .then((response) => {
                ...
                message.success("Successfully updated employee details"); // Add success message
            })
            .catch((error) => {
                console.error("Update failed:", error);
                message.error("Failed to update employee details"); // Add error message
            });
    };
...
export default PromotionMProfile;
